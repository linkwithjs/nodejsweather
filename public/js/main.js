...
const getInfo = async (event) => {
  ...
  if (cityVal === "") {
    city_name.innerText = `Please the city name before search.`;
    datahide.classList.add("data_hide");
  } else {
    try {
      let url = `https://api.openweathermap.org/data/2.5/weather?q=${cityVal}&appid=fcf28e0333c6f5d521e818c8c0c37c3c`;
